...
<div class="container">
    ...
    <div class="mb-3 col-lg-12 px-0">
        <img class="d-block w-100" src="./assets/img/livros-poster.png" >
    </div>
    ...
    <div class="row text-center mt-3">
        <div class="col-md-3 pb-1 pb-md-0  mb-3">
            <a href="detalheProduto.php" class="link">
                <div class="card avancar">
                    <div class="card-img-top d-flex align-items-center justify-content-center p-4">
                        <img src="assets\img\livro-09.png" alt="Card image cap" width="140px" height="140px">
                    </div>
                <div class="card-body">
                    <h3 class="card-title produto">Samsung S20</h3>
                    <p class="card-text preco">R$ 900,00</p>
